 <div class="home-blog">
          ...
          <div class="row">
            <div class="owl-home-blog owl-home-blog-sidebar"> 
              ...
              <!-- list hot news -->
              <div class="item">
                <div class="article"> <a href="index.php?controller=news_detail&id=<?php echo $row["pk_news_id"]; ?>" class="image"> <img src="public/upload/news/<?php echo $rows["c_img"]; ?>" alt="<?php echo $rows["c_name"]; ?>" title="<?php echo $rows["c_name"]; ?>" class="img-responsive"> </a>
                  <div class="info">
