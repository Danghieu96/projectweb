                ...
                <div class="col-xs-6 col-md-3 col-sm-6 ">
                  <div class="product-grid" id="product-1168979">
                    ...
                    <div class="info">
                      ...
                      <p class="price-box"> <span class="special-price"> <span class="price product-price"> <?php echo number_format($rows_noibat["c_price"]); ?>₫ </span> </span> </p>
            ...
            <div id="content-taba4" class="content-tab content-tab-proindex"> 
              ...
              <div class="col-xs-6 col-sm-4 col-md-3 ">
                <div class="product-grid product-loop" id="product-1142079">
                  <div class="image"> <a href="index.php?controller=product_detail&id=<?php echo $rows_new["pk_product_id"]; ?>"><img src="public/upload/product/<?php echo $rows_new["c_img"]; ?>" title="<?php echo $rows_new["c_name"]; ?>" alt="<?php echo $rows_new["c_name"]; ?>" class="img-responsive"></a> </div>
                  <div class="info">
                    <h3 class="name"><a href="index.php?controller=product_detail&id=<?php echo $rows_new["pk_product_id"]; ?>"><?php echo $rows_new["c_name"]; ?></a></h3>
