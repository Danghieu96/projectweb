...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.10&appId=1478828908838275';
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 mini-cart">
          <div class="wrapper-mini-cart"> <span class="icon"><i class="fa fa-shopping-cart"></i></span> <a href="cart"> <span class="mini-cart-count">
            <?php 
             ...
             ?>
          </span> <a href="index.php?controller=cart">sản phẩm</a> <i class="fa fa-caret-down"></i></a>
